...
let defaultService     = ../../dependencies/dhall-kubernetes/defaults/io.k8s.api.core.v1.Service.dhall
let defaultServiceSpec = ../../dependencies/dhall-kubernetes/defaults/io.k8s.api.core.v1.ServiceSpec.dhall
let defaultServicePort = ../../dependencies/dhall-kubernetes/defaults/io.k8s.api.core.v1.ServicePort.dhall
