...
let defaultEnvVarSource       = ../../dependencies/dhall-kubernetes/defaults/io.k8s.api.core.v1.EnvVarSource.dhall
let defaultSecretKeySelector  = ../../dependencies/dhall-kubernetes/defaults/io.k8s.api.core.v1.SecretKeySelector.dhall
